...
name: quant-aio
version: 2.1.1
description: 🐉 波龙股神量化交易系统 V2.1 — A股/期货一站式量化工作台。多因子选股 · A股回测(T+1/涨跌停) · 华鑫QMT实盘 · 文华财经期货 · 实时风控告警。搜索关键词：波龙股神、量化交易、选股、A股、期货、QMT、文华财经、回测、策略、投资、股票、炒股、量化、量化选股、自动交易、巧未来。Keywords: Bowlong, Quant Trading, Stock Picker, A-Share, Futures, QMT, Wenhua, Backtest, Strategy, Investment, Stock Trading, Quantitative, Auto Trading, Stock Screening, Technical Analysis, Simons, Jarvis, AI Trading
author: SimonsTang
license: MIT
...
metadata:
  openclaw:
    emoji: "📈"
    category: "finance"
    tags: ["A股", "期货", "量化", "QMT", "文华财经", "选股", "回测", "实盘", "风控", "波龙股神", "Bowlong", "tushare", "akshare", "量化交易", "股票", "炒股", "投资策略", "自动交易", "股票筛选", "技术分析", "巧未来", "西蒙斯", "贾维斯", "Quant Trading", "Stock Picker", "Futures", "Backtest", "AI Trading", "Investment"]
    requires:
      bins: ["python3"]
      env: ["TUSHARE_TOKEN"]
---
